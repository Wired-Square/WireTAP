// ui/src/apps/dashboard/dialogs/PanelConfigDialog.tsx
...
export default function PanelConfigDialog({ isOpen, onClose, panelId, onAddSignals, onReplaceSignal }: Props) {
  ...
  const updateSignalColour = useDashboardStore((s) => s.updateSignalColour);
  const updateSignalDisplayName = useDashboardStore((s) => s.updateSignalDisplayName);
  const updateSignalYAxis = useDashboardStore((s) => s.updateSignalYAxis);
  const reorderSignals = useDashboardStore((s) => s.reorderSignals);
  const removeSignalFromPanel = useDashboardStore((s) => s.removeSignalFromPanel);
