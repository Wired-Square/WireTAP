// ui/src/apps/graph/widgets/useSignalValues.ts
//
...
import { useGraphStore, type SignalRef } from "../../../stores/graphStore";
...
export function makeSignalSampler(keys: string[]): () => Float64Array {
  return () => {
    const buffers = useGraphStore.getState().seriesBuffers;
