...
import { useDashboardStore, buildAlignedData, type DashboardPanel, type SignalRef } from "../../../../../stores/dashboardStore";
...
export default function FlowViewPanel({ panel, canvasRef }: Props) {
  ...
  const updateData = useCallback(() => {
    ...
    const data = buildAlignedData(signals, useDashboardStore.getState().seriesBuffers) as uPlot.AlignedData;
